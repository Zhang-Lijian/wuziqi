...
//		}
	...
	public void paint(Graphics g) {
		...
		/**绘制棋子
		 * 在下棋时，棋子需要下到棋盘线条的交叉点处
		 * 此时，需要计算出          鼠标点击位置的坐标   和  离它最近的交叉点坐标的位置  
		 * 最近点的坐标     =  索引  * 网格的间距   + 距离窗口的边距
		 * 最后棋子应该显示到中心点    则这个最近点的坐标需要加减棋子的半径
		 * x = ((x+15)/30)*30;
		 * y = ((y+15)/30)*30;
...
//			JOptionPane.showMessageDialog(this, "请选择开始游戏！");
//			canPlay = true;
//		}
	...
	/**
	 * 判断游戏是否结束的方法
	 * 以当前棋子为中心向各个方向进行查找，找到五个相同的颜色即为游戏结束
	 * */
